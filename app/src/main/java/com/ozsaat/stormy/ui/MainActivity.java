...
import com.ozsaat.stormy.LocationProvider;
import com.ozsaat.stormy.R;
import com.ozsaat.stormy.weather.Current;
import com.ozsaat.stormy.weather.Day;
import com.ozsaat.stormy.weather.Forecast;
...
public class MainActivity extends AppCompatActivity implements LocationProvider.LocationCallback {
    ...
    private void getForecast(double currentLatitude, double currentLongitude) {
        String apiKey = "cc4d6d8610a17b884328ad5d381bfdf4";
